...
(67, '20220001', 'ad4817eaead4df26c8b6b4b48fb2158b', 'We, Wewer ', 1, '2022-12-29 22:42:42', '2022-12-29 22:42:42');
...
CREATE TABLE `client_seancat` (
  `client_id` int(30) NOT NULL,
  `seanca_id` int(30) NOT NULL DEFAULT 11,
  `name` varchar(255) NOT NULL,
  `seanca_date` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `client_seancat` (`client_id`, `seanca_id`, `name`, `seanca_date`) VALUES
(67, 1, '', '11.11.11'),
(67, 2, '', '22.22.22');
...
(15, '202200001', 57, 20, 0, 0, 0, 0, '0', '0', 'gh', 0, '2022-12-29 21:38:16', '2022-12-29 21:38:16');
...
INSERT INTO `seancat_list` (`id`, `name`, `seanca_date`, `status`, `date_created`, `date_updated`) VALUES
(1, 'Seanca 1', '', 1, '2022-08-31 06:43:14', '2022-12-29 21:50:45'),
...
(8, '202200001', 41, 4, 6, NULL, 1, '17:23:00', '2022-12-08', '2022-12-29 17:23:31');
...
--
-- Indexes for table `termin_list`
--
ALTER TABLE `termin_list`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `termin_list`
--
ALTER TABLE `termin_list`
