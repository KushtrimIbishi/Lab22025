...
<!-- Main Sidebar Container -->
      <aside id="top_nav" class="main-sidebar elevation-4 sidebar-no-expand bg-navy disabled">
        <!-- Brand Logo -->
        ...
        <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden">
          ...
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll; color: black;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%; color: black;">
                <!-- Sidebar user panel (optional) -->
                <div class="clearfix"></div>
                <!-- Sidebar Menu -->
                <nav id="side_dropdown" class="mt-4">
