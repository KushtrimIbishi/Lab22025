...
<div class="card card-outline card-primary">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<small class="text-info"><i>Leje te zbrazet nese nuk deshironi ta nderroni fjalekalimin</i></small>
                    <?php endif; ?>
				</div>
				<div class="form-group col-6">
					<label for="type">Lloji i perdoruesit</label>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary mr-2" form="manage-user">Ruaj</button>
					<a class="btn btn-sm btn-secondary" href="./?page=user/list">Anulo</a>
				</div>
			</div>
		</div>
</div>
