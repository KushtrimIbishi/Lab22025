...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Informacione rreth sistemit</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label">Emri i sistemit</label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">Emri i shkurte i sistemit</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logoja e sistemit</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="img" onchange="displayImg(this,$(this))">
	              <label class="custom-file-label" for="customFile">Zgjedh</label>
	            </div>
			</div>
			...
			<div class="form-group d-flex justify-content-center">
				<img src="./../uploads/mainLogo.png" alt="" id="cimg2" class="img-fluid img-thumbnail">
			</div>
			</form>
		</div>
