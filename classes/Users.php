...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(empty($id)){
			...
			if($qry){
				...
				$this->settings->set_flashdata('success','Te dhenat u ruajten me sukses.');
				$resp['status'] = 1;
			}else{
				$resp['status'] = 2;
			}
			...
			if($qry){
				$this->settings->set_flashdata('success','Te dhenat u perditesuan me sukses.');
	...
	public function delete_users(){
		...
		if($qry){
			...
			$this->settings->set_flashdata('success','Te dhenat u fshijten me sukses.');
